    ...
    <>    
      ...
      <main>
        ...
        <form onSubmit={submit}>
          ...
          <label>Title</label>
          <input name="title" placeholder="Please enter title of photo" onChange={handleChanges} value={formData.title}></input>
          <label>PhotoSrc</label>
          <input name="photoSrc"  placeholder="Please enter src of photo" onChange={handleChanges} value={formData.photoSrc}></input>
          <label>Model</label>
          <input name="model" placeholder="Please enter names of the model/s" onChange={handleChanges} value={formData.model}></input>
          <label>Description</label>
          <input name="desciption" placeholder="Please enter a description of the photo" onChange={handleChanges} value={formData.desciption}></input>
        ...
        <div className="displayPhotos">
          {photos.map((photo, _id) => (
              <div key={_id} className='photoToDelete'>
                  ...
                  <img className='photoDelete' src={require(`../../${photo.photoSrc}`)} alt={photo.title}></img>
                  {photo.faved && <button onClick={() => unFave(photo)}><MdFavorite/></button>}
                  {!photo.faved && <button onClick={() => makeFave(photo)}><MdOutlineFavoriteBorder/></button>}
                  <button className="deleteButton" onClick={() => deletePhoto(photo)}><AiFillDelete/></button>
              </div>
          ))}
        </div>
        </details>
